...
First and foremost, do a fresh install of Ubuntu 20.04 LTS on the SSD (primary drive). To quickly create a USB installer, refer to my [previous tutorial](https://healeyj.tumblr.com/post/644106042886799360/make-a-bootable-usb-with-dd-terminal-command).
